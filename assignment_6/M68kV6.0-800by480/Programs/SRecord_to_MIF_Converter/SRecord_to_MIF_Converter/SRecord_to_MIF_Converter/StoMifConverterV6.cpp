...
int main(int argc, char *argv[])
{
  ...
  if((SourceFilePtr =  fopen("C:\\Ide68k\\uCOSII\\lab6.hex", "r")) == NULL)	{
		fprintf(stderr, "Cannot Open S-Record File 'C:\\Ide68k\\uCOSII\\lab6.hex' for conversion to '.MIF' format\n") ;
		fprintf(stderr, "Hit any key to exit.....") ;
		getch() ;
		return 0 ;
	}
	
	if((DestFilePtr = fopen("C:\\Ide68k\\uCOSII\\lab6.mif","w")) == NULL)	{
		fprintf(stderr, "Cannot Open/Create file 'C:\\Ide68k\\uCOSII\\lab6.mif' to store output of file conversion\n") ;
		fprintf(stderr, "Hit any key to exit.....") ;
		getch() ;
		return 0 ;
	}  
