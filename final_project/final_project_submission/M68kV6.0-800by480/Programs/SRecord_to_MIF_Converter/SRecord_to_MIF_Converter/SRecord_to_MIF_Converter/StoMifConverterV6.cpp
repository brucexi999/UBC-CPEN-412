...
int main(int argc, char *argv[])
{
  ...
  if((SourceFilePtr =  fopen("C:\\M68kV6.0-800by480\\Programs\\DebugMonitorCode\\m68kdebugmonitor.hex", "r")) == NULL)	{
		fprintf(stderr, "Cannot Open S-Record File 'C:\\M68kV6.0-800by480\\Programs\\DebugMonitorCode\\m68kdebugmonitor.hex' for conversion to '.MIF' format\n") ;
		fprintf(stderr, "Hit any key to exit.....") ;
		getch() ;
		return 0 ;
	}
	
	if((DestFilePtr = fopen("C:\\M68kV6.0-800by480\\Programs\\DebugMonitorCode\\m68kdebugmonitor.mif","w")) == NULL)	{
		fprintf(stderr, "Cannot Open/Create file 'C:\\M68kV6.0-800by480\\Programs\\DebugMonitorCode\\m68kdebugmonitor.mif' to store output of file conversion\n") ;
		fprintf(stderr, "Hit any key to exit.....") ;
		getch() ;
		return 0 ;
	}  
